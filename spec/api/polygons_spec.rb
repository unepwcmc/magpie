...
describe "/polygons", type: :api do
  let(:geometry) { [[[[52.723388671875, 24.78174733781577], [52.5860595703125, 24.617057340809524], [53.25073242187499, 24.734358906253785], [52.723388671875, 24.78174733781577]]]] }
  ...
  it "should create polygon" do
    ...
    post "/areas_of_interest/#{@area_of_interest.id}/polygons", "polygon[geometry]=#{geometry}"
  ...
  context "there is one polygon" do
    ...
    it "should update polygon" do
      # Work-around to parse correctly the geometry
      put "/polygons/#{@polygon.id}", "polygon[geometry]=#{geometry}"
